...
public class AttackManager {
    ...
    public double getThirst() {
        ...
        if (mostTastefulHex.aiData.tastiness < 0.25 && aiMaster.money < 120) return 0;
    ...
    boolean tryToCaptureWithMoney(Hex hex, int defenseNumber) {
        ...
        int price = GameRules.PRICE_UNIT * strengthTemp;
    ...
    boolean tryToCaptureWithReinforcement(Hex hex, int defenseNumber) {
        ...
        if (defenseNumber==10) return false;
