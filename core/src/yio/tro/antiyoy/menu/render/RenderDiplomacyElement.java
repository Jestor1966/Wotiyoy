...
public class RenderDiplomacyElement extends MenuRender {
    ...
    public TextureRegion leaderIcon[];
    ...
    public void loadTextures() {
        ...
        leaderIcon=new TextureRegion[2];
        leaderIcon[0] = GraphicsYio.loadTextureRegion("diplomacy/leader_images/king.png", true);
        leaderIcon[1] = GraphicsYio.loadTextureRegion("diplomacy/leader_images/queen.png", true);
    ...
    private void renderItems() {
        ...
        diplomacyElement.leaderFont.setColor(Color.BLACK);
        ...
        diplomacyElement.leaderFont.setColor(Color.WHITE);
    ...
    private void renderItemStatus(DeItem item) {
        ...
        GraphicsYio.drawFromCenter(
                ...
                leaderIcon[(int)(Math.random())],
                item.statusPosition.x-74,
                item.statusPosition.y,
                item.statusRadius
        );
    }
    ...
    private void renderItemLeader(DeItem item) {
        if (diplomacyElement.appearFactor.get() == 0) return;

        diplomacyElement.leaderFont.draw(
                batch,
                item.leader,
                item.leaderPosition.x,
                item.leaderPosition.y
        );
    }
