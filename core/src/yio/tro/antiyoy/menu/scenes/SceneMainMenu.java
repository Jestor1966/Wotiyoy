...
public class SceneMainMenu extends AbstractScene{
    ...
    private void createUserInfo() {
        ButtonYio userButton = buttonFactory.getButton(generateSquare(0.7, 0.87, 0.15 * YioGdxGame.screenRatio), 1, null);
        menuControllerYio.loadButtonOnce(userButton, "menu/user_icon.png");
        userButton.setShadow(true);
        userButton.setAnimation(Animation.up);
        userButton.setTouchOffset(0.05f * GraphicsYio.width);
        userButton.setReaction(Reaction.rbAboutGame);
    }
