...
public class Scenes {
    ...
    public static SceneEventMessage sceneEventMessage;
    ...
    public static SceneChosenLands sceneChosenLands;
    ...
    public static SceneEditorEvent sceneEditorEvent;
    public static SceneEditorEventEditor sceneEditorEventEditor;
    public static SceneEvent sceneEvent;
    ...
    public static void createScenes(MenuControllerYio menuController) {
        ...
        sceneEventMessage = new SceneEventMessage(menuController);
        ...
        sceneChosenLands = new SceneChosenLands(menuController);
        ...
        sceneEditorEvent = new SceneEditorEvent(menuController);
        //sceneEditorEventEditor = new SceneEditorEventEditor(menuController);
