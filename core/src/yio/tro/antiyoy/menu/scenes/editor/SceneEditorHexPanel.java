...
public class SceneEditorHexPanel extends AbstractEditorPanel{
    ...
    private void initEditLandElement() {
        ...
        editLandElement.setPosition(generateRectangle(0.025, SceneEditorOverlay.PANEL_HEIGHT + 0.1, 0.95, 0.5));
    ...
    private void createBasePanel() {
        basePanel = buttonFactory.getButton(generateRectangle(0, SceneEditorOverlay.PANEL_HEIGHT, 1, 0.5), 12352, null);
