...
public class SceneEditorOverlay extends AbstractScene{
    ...
    private void createIcons() {
        ...
        createIconFromRight(150, 5, "menu/editor/event.png", rbEvent);
    ...
    private void initReactions() {
        ...
        rbEvent = new Reaction() {
            @Override
            public void perform(ButtonYio buttonYio) {
                getGameController(buttonYio).levelEditorManager.onEditorEventButtonPressed();
            }
        };
    }
