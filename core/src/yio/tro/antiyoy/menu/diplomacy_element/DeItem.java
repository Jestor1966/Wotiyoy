...
public class DeItem implements ReusableYio, Comparable<DeItem> {
    ...
    public PointYio titlePosition, statusPosition, descPosition,leaderPosition;
    public String title, descriptionString, leader;
    public int fraction;
    float titleOffset, statusOffset, descOffset, leaderOffset,statusOffDelta;
    float titleHeight, titleWidth, leaderHeight, leaderWidth;
    public int status;
    ...
    private void initMetrics() {
        ...
        leaderOffset = 0.35f * GraphicsYio.width;
...
//        titlePosition.y = (float) (position.y + (position.height + titleHeight) / 2);
    ...
    private void updateLeaderPosition() {
        leaderPosition.x = (float) (position.x + titleOffset);
        leaderPosition.y = (float) (position.y + position.height - descOffset * 1.75);
//        titlePosition.y = (float) (position.y + (position.height + titleHeight) / 2);
    }
    ...
    private void updateLeaderMetrics() {
        //diplomacyElement.leaderFont
        leaderHeight = GraphicsYio.getTextHeight(diplomacyElement.leaderFont, leader);
        leaderWidth = GraphicsYio.getTextWidth(diplomacyElement.leaderFont, leader);
    }
