...
public class DiplomacyElement extends InterfaceElement {
    ...
    public BitmapFont titleFont, descFont, leaderFont;
    ...
    public DiplomacyElement(MenuControllerYio menuControllerYio, int id) {
        ...
        leaderFont = Fonts.smallerMenuFont;
    ...
    private void initMetrics() {
        itemHeight = 0.25f * GraphicsYio.width;
        topLabelHeight = (0.2f * GraphicsYio.width) / 2;
    ...
    private void addItem(DiplomaticEntity relationEntity) {
        ...
        deItem.setLeader(relationEntity.leaderName);
