...
public class DiplomaticEntity implements ReusableYio {
    ...
    public int fraction;
    public String capitalName,leaderName;
    ...
    public void updateCapitalName() {
        ...
        if (largestProvince == null) {
            ...
            leaderName = LeaderNameGenerator.getInstance().generateName(capital);
            return;
        }
        ...
        leaderName=gameController.namingManager.getProvinceLeader(largestProvince);
        //System.out.println(gameController.namingManager.getProvinceLeader(largestProvince));
        //System.out.println("{"+gameController.namingManager.getProvinceName(largestProvince)+"}");
    }

    public void updateLeaderName() {
        Province largestProvince = getLargestProvince(fraction);
