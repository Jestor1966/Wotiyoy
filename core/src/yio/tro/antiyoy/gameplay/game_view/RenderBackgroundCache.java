...
public class RenderBackgroundCache extends GameRender {
    ...
    public void prepareCacheItems() {
        ...
        addCacheItem(2, 1);
        addCacheItem(2, 0);
        if (gameController.levelSizeManager.levelSize < LevelSize.GIANT) return;
...
/*
        ...
        if (gameController.levelSizeManager.levelSize < LevelSize.WORLD) return;
        addCacheItem(5, 0);
        addCacheItem(5, 1);
        addCacheItem(5, 2);
        addCacheItem(5, 3);
    ...
    private void renderBackground() {
        batchCache.draw(gameView.texturesManager.backgroundRegion, 0, 0, 6 * GraphicsYio.width, 6 * GraphicsYio.height);
    }
