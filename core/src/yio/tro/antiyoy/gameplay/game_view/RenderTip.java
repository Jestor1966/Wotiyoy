    ...
    private TextureRegion getTipTypeTexture(int tipShowType) {
        switch (tipShowType) {
            ...
            case SelectionTipType.TREE:
                return gameView.texturesManager.pineTexture[0].getNormal();
            ...
            case SelectionTipType.UNIT_5:
                return gameView.texturesManager.manTextures[4].getNormal();
            case SelectionTipType.UNIT_6:
                return gameView.texturesManager.manTextures[5].getNormal();
            case SelectionTipType.UNIT_7:
                return gameView.texturesManager.manTextures[6].getNormal();
            case SelectionTipType.UNIT_8:
                return gameView.texturesManager.manTextures[7].getNormal();
            case SelectionTipType.UNIT_9:
                return gameView.texturesManager.manTextures[8].getNormal();
