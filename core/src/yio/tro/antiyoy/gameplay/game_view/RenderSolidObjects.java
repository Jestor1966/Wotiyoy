...
public class RenderSolidObjects extends GameRender{
    ...
    private TextureRegion getSolidObjectTexture(Hex hex, int quality) {
        switch (hex.objectInside) {
            ...
            case Obj.PALM:
                return gameView.texturesManager.palmTexture[hex.visualDiversityIndex2].getTexture(quality);
            case Obj.PINE:
                return gameView.texturesManager.pineTexture[hex.visualDiversityIndex2].getTexture(quality);
            case Obj.TOWER:
            ...
            case Obj.FORT:
                return gameView.texturesManager.fortTexture.getTexture(quality);
            case Obj.REVOLT:
