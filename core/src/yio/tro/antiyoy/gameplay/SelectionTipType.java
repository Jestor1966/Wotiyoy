...
public class SelectionTipType {
    ...
    public static final int UNIT_5 = 8;
    public static final int UNIT_6 = 9;
    public static final int UNIT_7 = 10;
    public static final int UNIT_8 = 11;
    public static final int UNIT_9 = 12;
}
