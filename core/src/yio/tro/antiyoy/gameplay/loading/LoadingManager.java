...
public class LoadingManager {
    ...
    public WideScreenCompensationManager compensationManager;
    ...
    private void createRestartLevelCode() {
        ...
        //GameRules.captainAsCityRules = GameRules.captainAsCityRules;
...
//        parameters.showInConsole();
    ...
    private void applyLoadingParameters() {
        ...
        GameRules.setCaptainAsCityRules(parameters.captainAsCity);
    }
}
