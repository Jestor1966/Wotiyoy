...
public class LoadingParameters {
    ...
    public String preparedEventData;
    ...
    public void copyFrom(LoadingParameters src) {
        ...
        captainAsCity = src.captainAsCity;
        ...
        preparedEventData = src.preparedEventData;
    ...
    public void showInConsole() {
        ...
        System.out.println("preparedEventData = " + preparedEventData);
    ...
    public void loadBasicInfo(Preferences prefs) {
        ...
        captainAsCity = prefs.getBoolean("captain_as_city",false);
