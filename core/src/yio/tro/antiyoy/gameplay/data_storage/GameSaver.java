...
public class GameSaver {
    ...
    private void saveBasicInfo() {
        ...
        prefs.putBoolean("event_enable", GameRules.eventEnabled);
        prefs.putBoolean("captain_as_city", GameRules.captainAsCityRules);
    ...
    private void saveEvent(){
        String eventString = gameController.eventManager.encode();
        prefs.putString("save_event",eventString);
    }
